...
export const PROVIDER_CATALOG: CatalogEntry[] = [
  ...
  { id: "groq", name: "Groq (fast open models)", baseURL: "https://api.groq.com/openai/v1", needsKey: true },
  ...
  { id: "cerebras", name: "Cerebras (ultra fast)", baseURL: "https://api.cerebras.ai/v1", needsKey: true },
